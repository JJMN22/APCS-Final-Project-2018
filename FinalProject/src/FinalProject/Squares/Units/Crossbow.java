...
public class Crossbow extends Troop {
    private ImageIcon redIcon = new ImageIcon(getClass().getResource("redCrossbow.png"));
    private ImageIcon blueIcon = new ImageIcon(getClass().getResource("blueCrossbow.png"));
    
    int health = 100;
    int damage = 50;
    int cost = 85;
    
    public Crossbow(int xPos, int yPos, boolean team){
