...
public class FieldCannon extends Troop {
    private ImageIcon redIcon = new ImageIcon(getClass().getResource("redFieldCannon.png"));
    private ImageIcon blueIcon = new ImageIcon(getClass().getResource("blueFieldCannon.png"));
    
    int health = 150;
    int damage = 75;
    int cost = 150;
    
    public FieldCannon(int xPos, int yPos, boolean team){
